...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructorCallbackFunction*) &Arcadia_ADL_PixelBufferReader_constructImpl,
...
;
  ...
  Arcadia_ADL_PixelBufferDefinition* definition = Arcadia_ADL_PixelBufferDefinition_create(thread, definitions, name);
  return definition;
}
  ...
  )
{
  ...
  ((Arcadia_ADL_Reader*)self)->read = (Arcadia_ADL_Definition* (*)(Arcadia_Thread*, Arcadia_ADL_Reader*, Arcadia_ADL_Definitions*, Arcadia_DDL_Node*)) & Arcadia_ADL_PixelBufferReader_read;
