...
#if !defined(ARCADIA_ADL_PIXELBUFFEROPERATIONS_CHECKERBOARDFILLOPERATIONDEFINITION_H_INCLUDED)
#define ARCADIA_ADL_PIXELBUFFEROPERATIONS_CHECKERBOARDFILLOPERATIONDEFINITION_H_INCLUDED
...
//
//   field firstCheckerColor : Arcadia.ADL.ColorDefinition
//   field firstCheckerColorName : Arcadia.String
//
//   field secondCheckerColor : Arcadia.ADL.ColorDefinition
//   field secondCheckerColorName : Arcadia.String
//
...
struct Arcadia_ADL_PixelBufferOperations_CheckerboardFillOperationDefinition {
  ...
  Arcadia_ADL_ColorDefinition* firstCheckerColorDefinition;
  Arcadia_String* firstCheckerColorReference;
  
  Arcadia_ADL_ColorDefinition* secondCheckerColorDefinition;
  Arcadia_String* secondCheckerColorReference;
};
...
#endif  // ARCADIA_ADL_PIXELBUFFEROPERATIONS_CHECKERBOARDFILLOPERATIONDEFINITION_H_INCLUDED
