...
#if !defined(ARCADIA_ADL_PIXELBUFFEROPERATIONS_FILLOPERATIONREADER_H_INCLUDED)
#define ARCADIA_ADL_PIXELBUFFEROPERATIONS_FILLOPERATIONREADER_H_INCLUDED
...
#endif  // ARCADIA_ADL_PIXELBUFFEROPERATIONS_FILLOPERATIONREADER_H_INCLUDED
