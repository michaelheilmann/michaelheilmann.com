...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructorCallbackFunction*) & Arcadia_ADL_Context_constructImpl,
  ...
  )
{
  ...
  Arcadia_ADL_Definition* definition = Arcadia_ADL_Reader_read(thread, reader, definitions, (Arcadia_DDL_Node*)input);
