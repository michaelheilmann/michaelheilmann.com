...
static const Arcadia_ObjectType_Operations _Arcadia_Audials_SceneNodeFactory_objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructorCallbackFunction*) & Arcadia_Audials_SceneNodeFactory_construct,
  .destruct = (Arcadia_Object_DestructorCallbackFunction*)&Arcadia_Audials_SceneNodeFactory_destruct,
