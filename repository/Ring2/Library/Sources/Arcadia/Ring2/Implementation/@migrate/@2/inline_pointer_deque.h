...
/// @error #Core_Error_ArgumentInvalid @a index is greater than or equal to the size of this dx_inline_pointer_deque object
/// @method{dx_inline_pointer_deque}
Core_Result dx_inline_pointer_deque_remove(dx_inline_pointer_deque_element* RETURN, dx_inline_pointer_deque* SELF, dx_bool steal, Core_Size index);
...
/// @method{dx_inline_pointer_deque}
Core_Result dx_inline_pointer_deque_pop_front(dx_inline_pointer_deque_element* RETURN, dx_inline_pointer_deque* SELF, dx_bool steal);
...
/// @error #Core_Error_ArgumentInvalid the deque is empty
/// @method{dx_inline_pointer_deque}
Core_Result dx_inline_pointer_deque_pop_back(dx_inline_pointer_deque_element* RETURN, dx_inline_pointer_deque* SELF, dx_bool steal);
