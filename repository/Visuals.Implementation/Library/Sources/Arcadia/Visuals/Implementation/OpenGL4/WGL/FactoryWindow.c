  ...
  )
{
  ...
  Arcadia_Visuals_OpenGL_WGL_FactoryWindow* self = Arcadia_allocateObject(thread, _Arcadia_Visuals_OpenGL_WGL_FactoryWindow_getType(thread), 0, &argumentValues[0]);
  return self;
}
