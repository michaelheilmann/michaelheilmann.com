  ...
  )
{
  ...
  Arcadia_Visuals_OpenGL_WGL_FactoryContext* self = Arcadia_allocateObject(thread, _Arcadia_Visuals_OpenGL_WGL_FactoryContext_getType(thread), 0, &argumentValues[0]);
  return self;
}
