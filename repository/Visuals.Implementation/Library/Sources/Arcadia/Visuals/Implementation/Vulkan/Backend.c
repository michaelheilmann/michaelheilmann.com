...
static void
Arcadia_Visuals_Implementation_Vulkan_Backend_openImpl
  (
...
static void
Arcadia_Visuals_Implementation_Vulkan_Backend_closeImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Visuals_Implementation_Vulkan_Backend* self
  );
...
static const Arcadia_ObjectType_Operations _Arcadia_Visuals_Implementation_Vulkan_Backend_objectTypeOperations = {
  ...
  .destruct = &Arcadia_Visuals_Implementation_Vulkan_Backend_destruct,
  .visit = &Arcadia_Visuals_Implementation_Vulkan_Backend_visit,
};
  ...
  )
{
  ...
  ((Arcadia_Visuals_Backend*)self)->open = (void (*)(Arcadia_Thread*, Arcadia_Visuals_Backend*))& Arcadia_Visuals_Implementation_Vulkan_Backend_openImpl;
  ((Arcadia_Visuals_Backend*)self)->close = (void (*)(Arcadia_Thread*, Arcadia_Visuals_Backend*))& Arcadia_Visuals_Implementation_Vulkan_Backend_closeImpl;
  ((Arcadia_Visuals_Backend*)self)->getName = (Arcadia_String* (*)(Arcadia_Thread*, Arcadia_Visuals_Backend*))& Arcadia_Visuals_Implementation_Vulkan_Backend_getNameImpl;
