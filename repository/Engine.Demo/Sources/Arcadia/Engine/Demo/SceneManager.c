...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructorCallbackFunction*)&Arcadia_Engine_Demo_SceneManager_constructImpl,
  .destruct = (Arcadia_Object_DestructorCallbackFunction*)&Arcadia_Engine_Demo_SceneManager_destructImpl,
  .visit = (Arcadia_Object_DestructorCallbackFunction*)&Arcadia_Engine_Demo_SceneManager_visitImpl,
};
