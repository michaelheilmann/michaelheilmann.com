...
#include "Arcadia/Imaging/Windows/NativeWindowsImageWriter.h"
...
NativeWindowsImageWriter_getSupportedTypes
  (
...
static void
NativeWindowsImageWriter_writeToPathImpl
  (
    Arcadia_Thread* thread,
    NativeWindowsImageWriter* self,
...
static void
NativeWindowsImageWriter_writeToByteBufferImpl
  (
    Arcadia_Thread* thread,
    NativeWindowsImageWriter* self,
    Arcadia_String* extension,
  ...
  )
{
  ...
  if (Arcadia_Value_isEqualTo(thread, &a, &b[0])) {
    ...
    NativeWindowsImageWriter_writeBmpToPathImpl(thread, self, (Arcadia_Visuals_PixelBuffer*)sourceObject, targetPath);
  } else if (Arcadia_Value_isEqualTo(thread, &a, &b[1])) {
    if (1 != Arcadia_Collection_getSize(thread, (Arcadia_Collection*)sourcePixelBuffers)) {
      Arcadia_Thread_setStatus(thread, Arcadia_Status_ArgumentValueInvalid);
      Arcadia_Thread_jump(thread);
    }
    ...
    NativeWindowsImageWriter_writePngToPathImpl(thread, self, (Arcadia_Visuals_PixelBuffer*)sourceObject, targetPath);
  } else if (Arcadia_Value_isEqualTo(thread, &a, &b[2])) {
    NativeWindowsImageWriter_writeIcoToPathImpl(thread, self, sourcePixelBuffers, targetPath);
  } else {
    Arcadia_Thread_setStatus(thread, Arcadia_Status_ArgumentValueInvalid);
    Arcadia_Thread_jump(thread);
  }
  ...
  )
{
  ...
  if (Arcadia_Value_isEqualTo(thread, &a, &b[0])) {
    ...
    NativeWindowsImageWriter_writeBmpToByteBufferImpl(thread, self, (Arcadia_Visuals_PixelBuffer*)sourceObject, targetByteBuffer);
  } else if (Arcadia_Value_isEqualTo(thread, &a, &b[1])) {
    if (1 != Arcadia_Collection_getSize(thread, (Arcadia_Collection*)sourcePixelBuffers)) {
      Arcadia_Thread_setStatus(thread, Arcadia_Status_ArgumentValueInvalid);
      Arcadia_Thread_jump(thread);
    ...
    NativeWindowsImageWriter_writePngToByteBufferImpl(thread, self, (Arcadia_Visuals_PixelBuffer*)sourceObject, targetByteBuffer);
  } else if (Arcadia_Value_isEqualTo(thread, &a, &b[2])) {
    NativeWindowsImageWriter_writeIcoToByteBufferImpl(thread, self, sourcePixelBuffers, targetByteBuffer);
  } else {
    Arcadia_Thread_setStatus(thread, Arcadia_Status_ArgumentValueInvalid);
    Arcadia_Thread_jump(thread);
  }
  ...
  )
{
  ...
  for (Arcadia_SizeValue i = 0, offset = 0, n = Arcadia_Collection_getSize(thread, (Arcadia_Collection*)sourcePixelBuffers); i < n; ++i) {
    ...
    ImageWriter_writeToByteBuffer(thread, (ImageWriter*)self, pngExtension, pixelBuffers, byteBuffer);
    ...
    ICONDIRENTRY iconDirEntry = { .width = width,
                                  ...
                                  .imageSize = Arcadia_ByteBuffer_getSize(thread, byteBuffer),
    ...
    offset += Arcadia_ByteBuffer_getSize(thread, byteBuffer);
  }
  for (Arcadia_SizeValue i = 0, offset = 0, n = Arcadia_Collection_getSize(thread, (Arcadia_Collection*)sourcePixelBuffers); i < n; ++i) {
    Arcadia_Visuals_PixelBuffer* pixelBuffer = (Arcadia_Visuals_PixelBuffer*)Arcadia_List_getObjectReferenceValueAt(thread, sourcePixelBuffers, i);
    Arcadia_Collection_clear(thread, (Arcadia_Collection*)pixelBuffers);
    ...
    Arcadia_ByteBuffer_clear(thread, byteBuffer);
    ImageWriter_writeToByteBuffer(thread, (ImageWriter*)self, pngExtension, pixelBuffers, byteBuffer);
    Arcadia_ByteBuffer_append_pn(thread, targetByteBuffer, byteBuffer->p, byteBuffer->sz);
    offset += Arcadia_ByteBuffer_getSize(thread, byteBuffer);
  }
}
  ...
  )
{
  ...
  ((ImageWriter*)_self)->getSupportedTypes = (Arcadia_ImmutableList * (*)(Arcadia_Thread*, ImageWriter*))&NativeWindowsImageWriter_getSupportedTypes;
  ((ImageWriter*)_self)->writeToPath = (void (*)(Arcadia_Thread*, ImageWriter*, Arcadia_String*, Arcadia_List*, Arcadia_String*)) & NativeWindowsImageWriter_writeToPathImpl;
  ((ImageWriter*)_self)->writeToByteBuffer = (void (*)(Arcadia_Thread*, ImageWriter*, Arcadia_String*, Arcadia_List*, Arcadia_ByteBuffer*)) & NativeWindowsImageWriter_writeToByteBufferImpl;
