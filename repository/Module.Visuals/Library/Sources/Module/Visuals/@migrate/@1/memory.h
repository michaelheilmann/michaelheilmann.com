...
struct dx_allocator_statistics {
  Core_Size smallestBlock;     ///< The size, in Bytes, of the greatest block allocated.
  ...
  Core_Size greatestBlock;     ///< The size, in Bytes, of the greatest block allocated.
                               ///< Can be @a 0 even if Blocks are allocated as Blocks can have zero size.
                               ///< If no blocks are currently allocated, then the value is @a 0.
  Core_Size numberOfBlocks;    ///< The number of blocks currently allocated.
                               ///< The sum of the sizes, in Bytes, of all these blocks is the number of Bytes/KiloBytes allocated.
  Core_Size numberOfBytes;     ///< The number of Bytes currently allocated.
  Core_Size numberOfKiloBytes; ///< The number of KiloBytes currently allocated (1 KiloByte = 1000 Bytes).
};
