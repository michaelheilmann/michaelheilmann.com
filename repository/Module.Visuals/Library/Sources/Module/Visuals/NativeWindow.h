...
Rex_declareObjectType("NativeWindow", NativeWindow, "R.Object");

struct NativeWindow {
  R_Object _parent;

  void (*open)(NativeWindow*);

  void (*close)(NativeWindow*);

  R_BooleanValue (*getQuitRequested)(NativeWindow*);

  void (*setQuitRequested)(NativeWindow*, R_BooleanValue);

  void (*update)(NativeWindow*);

  void (*getRequiredBigIconSize)(NativeWindow*, R_Integer32Value*, R_Integer32Value*);

  void (*getRequiredSmallIconSize)(NativeWindow*, R_Integer32Value*, R_Integer32Value*);
  ...
  void (*setTitle)(NativeWindow*, R_String*);

  void (*getCanvasSize)(NativeWindow*, R_Integer32Value*, R_Integer32Value*);
...
/// @param self A pointer to this window.
/// @return #R_BooleanValue_True if this application was requested to quit. #R_BooleanValue_False if this application was requested to continue.
R_BooleanValue
...
/// @param self A pointer to this window.
/// @param quitRequested #R_BooleanValue requests the application to quit. #R_BooleanValue_False request the application to continue.
void
