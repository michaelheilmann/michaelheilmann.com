...
{
  Arcadia_Value argumentValues[] = {
    { .tag = Arcadia_ValueTag_Natural64, .natural64Value = timestamp },
    { .tag = Arcadia_ValueTag_Integer32, .integer32Value = action },
    { .tag = Arcadia_ValueTag_Natural64, .natural64Value = button },
    { .tag = Arcadia_ValueTag_Integer32, .integer32Value = x },
    { .tag = Arcadia_ValueTag_Integer32, .integer32Value = y }, };
