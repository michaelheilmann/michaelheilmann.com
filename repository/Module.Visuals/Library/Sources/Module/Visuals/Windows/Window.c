  ...
  )
{
  for (Arcadia_SizeValue i = 0, n = Arcadia_List_getSize(thread, configurations); i < n; ++i) {
    ...
    Arcadia_Value a, b;
    a = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = element->opengl.version.major };
    b = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = configuration->opengl.version.major };
    if (!Arcadia_Value_isEqualTo(thread, &a, &b)) {
      continue;
    }
    a = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = element->opengl.version.minor };
    b = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = configuration->opengl.version.minor };
    if (!Arcadia_Value_isEqualTo(thread, &a, &b)) {
      continue;
    }
    a = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = element->colorBuffer.redBits };
    b = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = configuration->colorBuffer.redBits };
    if (!Arcadia_Value_isEqualTo(thread, &a, &b)) {
      continue;
    }
    a = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = element->colorBuffer.greenBits };
    b = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = configuration->colorBuffer.greenBits };
    if (!Arcadia_Value_isEqualTo(thread, &a, &b)) {
      continue;
    }
    a = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = element->colorBuffer.blueBits };
    b = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = configuration->colorBuffer.blueBits };
    if (!Arcadia_Value_isEqualTo(thread, &a, &b)) {
      continue;
    }
    a = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = element->colorBuffer.alphaBits };
    b = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = configuration->colorBuffer.alphaBits };
    if (!Arcadia_Value_isEqualTo(thread, &a, &b)) {
      continue;
    }
    a = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = element->depthBuffer.depthBits };
    b = (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = configuration->depthBuffer.depthBits };
    if (!Arcadia_Value_isEqualTo(thread, &a, &b)) {
      continue;
    }
  ...
  )
{
  ...
  for (Arcadia_SizeValue i = 0, n = Arcadia_List_getSize(thread, supportedConfigurations); i < n; ++i) {
    ...
    Arcadia_StringBuffer_append(thread, stringBuffer, (Arcadia_Value){ .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = (Arcadia_ObjectReferenceValue)supportedConfiguration->colorBuffer.redBits });
    ...
    Arcadia_StringBuffer_append(thread, stringBuffer, (Arcadia_Value) { .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = (Arcadia_ObjectReferenceValue)supportedConfiguration->colorBuffer.greenBits });
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"blue bits: ", sizeof(u8"blue bits: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, (Arcadia_Value) { .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = (Arcadia_ObjectReferenceValue)supportedConfiguration->colorBuffer.blueBits });
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"alpha bits: ", sizeof(u8"alpha bits: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, (Arcadia_Value) { .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = (Arcadia_ObjectReferenceValue)supportedConfiguration->colorBuffer.alphaBits });
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"depth bits: ", sizeof(u8"depth bits: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, (Arcadia_Value) { .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = (Arcadia_ObjectReferenceValue)supportedConfiguration->depthBuffer.depthBits });
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"OpenGL major version: ", sizeof(u8"OpenGL major version: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, (Arcadia_Value) { .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = (Arcadia_ObjectReferenceValue)supportedConfiguration->opengl.version.major });
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"OpenGL minor version: ", sizeof(u8"OpenGL minor version: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, (Arcadia_Value) { .tag = Arcadia_ValueTag_ObjectReference, .objectReferenceValue = (Arcadia_ObjectReferenceValue)supportedConfiguration->opengl.version.minor });
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);
