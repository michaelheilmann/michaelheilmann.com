  ...
  )
{
  ...
  for (Arcadia_SizeValue i = 0, n = Arcadia_List_getSize(thread, supportedConfigurations); i < n; ++i) {
    ...
    Arcadia_StringBuffer_append(thread, stringBuffer, Arcadia_Value_makeObjectReferenceValue(supportedConfiguration->colorBuffer.redBits));
    ...
    Arcadia_StringBuffer_append(thread, stringBuffer, Arcadia_Value_makeObjectReferenceValue(supportedConfiguration->colorBuffer.greenBits));
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"blue bits: ", sizeof(u8"blue bits: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, Arcadia_Value_makeObjectReferenceValue(supportedConfiguration->colorBuffer.blueBits));
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"alpha bits: ", sizeof(u8"alpha bits: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, Arcadia_Value_makeObjectReferenceValue(supportedConfiguration->colorBuffer.alphaBits));
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"depth bits: ", sizeof(u8"depth bits: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, Arcadia_Value_makeObjectReferenceValue(supportedConfiguration->depthBuffer.depthBits));
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"OpenGL major version: ", sizeof(u8"OpenGL major version: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, Arcadia_Value_makeObjectReferenceValue(supportedConfiguration->opengl.version.major));
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);

    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"OpenGL minor version: ", sizeof(u8"OpenGL minor version: ") - 1);
    Arcadia_StringBuffer_append(thread, stringBuffer, Arcadia_Value_makeObjectReferenceValue(supportedConfiguration->opengl.version.minor));
    Arcadia_StringBuffer_append_pn(thread, stringBuffer, u8"\n", sizeof(u8"\n") - 1);
