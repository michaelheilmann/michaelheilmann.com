...
static Core_Result _dx_impl_remove(dx_inline_pointer_deque_element* RETURN, _dx_impl* SELF, dx_bool steal, Core_Size index);
...
static Core_Result _dx_impl_pop_front(dx_inline_pointer_deque_element* RETURN, _dx_impl* SELF, dx_bool steal);
...
/// @error #Core_Error_ArgumentInvalid @a SELF is a null pointer
/// @error #Core_Error_ArgumentInvalid the deque is empty
static Core_Result _dx_impl_pop_back(dx_inline_pointer_deque_element * RETURN, _dx_impl * SELF, dx_bool steal);
