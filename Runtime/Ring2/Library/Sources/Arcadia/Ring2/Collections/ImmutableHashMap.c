...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructorCallbackFunction*)&Arcadia_ImmutableHashMap_constructImpl,
  .destruct = (Arcadia_Object_DestructorCallbackFunction*)&Arcadia_ImmutableHashMap_destruct,
  ...
  )
{
  ...
  ((Arcadia_Collection*)self)->clear = (void (*)(Arcadia_Thread*, Arcadia_Collection*)) & Arcadia_ImmutableHashMap_clearImpl;
  ((Arcadia_Collection*)self)->getSize = (Arcadia_SizeValue(*)(Arcadia_Thread*, Arcadia_Collection*)) & Arcadia_ImmutableHashMap_getSizeImpl;
  ((Arcadia_Collection*)self)->isImmutable = (Arcadia_BooleanValue(*)(Arcadia_Thread*, Arcadia_Collection*)) & Arcadia_ImmutableHashMap_isImmutableImpl;
  ((Arcadia_Map*)self)->get = (Arcadia_Value(*)(Arcadia_Thread*, Arcadia_Map*, Arcadia_Value)) & Arcadia_ImmutableHashMap_getImpl;
  ((Arcadia_Map*)self)->remove = (void (*)(Arcadia_Thread*, Arcadia_Map*, Arcadia_Value, Arcadia_Value*, Arcadia_Value*)) & Arcadia_ImmutableHashMap_removeImpl;
  ((Arcadia_Map*)self)->set = (void (*)(Arcadia_Thread*, Arcadia_Map*, Arcadia_Value, Arcadia_Value, Arcadia_Value*, Arcadia_Value*)) & Arcadia_ImmutableHashMap_setImpl;
  ((Arcadia_Map*)self)->getKeys = (Arcadia_List * (*)(Arcadia_Thread*, Arcadia_Map*)) & Arcadia_ImmutableHashMap_getKeysImpl;
  ((Arcadia_Map*)self)->getValues = (Arcadia_List * (*)(Arcadia_Thread*, Arcadia_Map*)) & Arcadia_ImmutableHashMap_getValuesImpl;
