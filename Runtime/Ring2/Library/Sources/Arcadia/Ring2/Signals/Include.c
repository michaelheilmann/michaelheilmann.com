...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructorCallbackFunction*)&Arcadia_Signal_constructImpl,
  .destruct = (Arcadia_Object_DestructorCallbackFunction*)&Arcadia_Signal_destructImpl,
  .visit = (Arcadia_Object_DestructorCallbackFunction*)&Arcadia_Signal_visitImpl,
};
